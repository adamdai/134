...
int main(int argc, char **argv)
{
  ...
  //cmdMsg.name.push_back("baseplate_attachment");
  //cmdMsg.name.push_back("motor1_attachment");
  cmdMsg.name.push_back("link1_attachment");
  //cmdMsg.name.push_back("motor2_attachment");
  cmdMsg.name.push_back("link2_attachment");
  //cmdMsg.name.push_back("motor3_attachment");
  cmdMsg.name.push_back("link3_attachment");
  
  cmdMsg.position.resize(3);
  cmdMsg.velocity.resize(3);
