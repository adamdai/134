...
(cl:defmethod rad-val ((m <Coord>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection-msg:rad-val is deprecated.  Use detection-msg:rad instead.")
  (rad m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Coord>)))
  ...
  "8f879a2a243e539d8a83499d13d1ab5a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Coord)))
  "Returns md5sum for a message object of type 'Coord"
  "8f879a2a243e539d8a83499d13d1ab5a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Coord>)))
  ...
  (cl:format cl:nil "# Message definition of a coordinate~%float64 rad~%float64 angle~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Coord)))
  "Returns full string definition for message of type 'Coord"
  (cl:format cl:nil "# Message definition of a coordinate~%float64 rad~%float64 angle~%~%"))
