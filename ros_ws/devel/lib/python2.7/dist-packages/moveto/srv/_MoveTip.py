...
class MoveTipRequest(genpy.Message):
  _md5sum = "345daa59b4dd0cc9b1994a20bb0ca2a7"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3dB().pack(_x.tip.x, _x.tip.y, _x.tip.z, _x.tip.grip))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.tip.x, _x.tip.y, _x.tip.z, _x.tip.grip,) = _get_struct_3dB().unpack(str[start:end])
...
class MoveTip(object):
  ...
  _md5sum = '5ebb5876bcc8be930d43a2e07942295f'
