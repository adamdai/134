...
"""autogenerated by genpy from hebiros/WaypointMsg.msg. Do not edit."""
import sys
...
class WaypointMsg(genpy.Message):
  _md5sum = "12d00299a1473fdb80467671a849aff2"
  _type = "hebiros/WaypointMsg"
...
"""
  __slots__ = ['names','positions','velocities','accelerations']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(WaypointMsg, self).__init__(*args, **kwds)
