...
"""autogenerated by genpy from hebiros/TrajectoryActionFeedback.msg. Do not edit."""
import sys
...
class TrajectoryActionFeedback(genpy.Message):
  ...
  _type = "hebiros/TrajectoryActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hebiros/TrajectoryFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = hebiros.msg.TrajectoryFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hebiros.msg.TrajectoryFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_d().pack(self.feedback.percent_complete))
